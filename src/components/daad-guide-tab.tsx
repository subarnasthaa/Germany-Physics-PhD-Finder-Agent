...
export default function MEXTGuideTab() {
  ...
  const requiredDocuments = [
    ...
    { id: 'daad-form', label: 'MEXT Application Form (online)' },
  ...
  return (
    <div className="space-y-6 p-4 md:p-6">
      {/* Header */}
      <Card className="border-0 bg-gradient-to-r from-red-600 via-yellow-500 to-red-600 text-white overflow-hidden">
        <CardContent className="p-6 md:p-8">
          ...
          <p className="text-red-100 text-sm max-w-xl">
            ...
            MEXT (Deutscher Akademischer Austauschdienst) is the world&apos;s largest funding organization for international academic exchange.
          </p>
        </CardContent>
      </Card>

      {/* MEXT Research Grants Section */}
      <Card className="border-red-200 dark:border-amber-800/50">
        <CardContent className="p-4 md:p-6">
          <div className="flex items-start gap-4">
            <div className="size-12 rounded-xl bg-red-100 dark:bg-amber-900/30 flex items-center justify-center shrink-0">
              <BookOpen className="size-6 text-red-600" />
            </div>
            <div>
              <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-1">MEXT Research Grants</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">
                The most popular MEXT program for PhD students. Provides monthly stipend of ¥144,000,
              ...
              <div className="space-y-1 text-xs text-gray-500 dark:text-gray-400">
                ...
                <p>• <strong>Health Insurance:</strong> Covered by MEXT</p>
      ...
      <Card className="border-gray-200 dark:border-gray-700">
        <CardContent className="p-4 md:p-6">
          <h3 className="text-sm font-bold text-gray-900 dark:text-white mb-3">🇩🇪 Embassy of Japan in Nepal</h3>
      ...
      <Card>
        <CardContent className="p-4 md:p-6">
          ...
          <div className="space-y-3">
            {[
              { step: 1, month: 'Jan-Mar', desc: 'Research programs, contact potential supervisors', color: 'bg-red-500' },
              { step: 2, month: 'Apr-May', desc: 'Prepare documents, take language tests (IELTS/TOEFL)', color: 'bg-red-600' },
              { step: 3, month: 'Jun-Jul', desc: 'Submit MEXT scholarship application (deadline usually July)', color: 'bg-red-700' },
              ...
              { step: 7, month: 'Mar-Apr', desc: 'Arrive in Germany, enroll, start research!', color: 'bg-red-600' },
            ].map((item) => (
          ...
          <div className="space-y-2 text-xs text-gray-600 dark:text-gray-400">
            ...
            <div className="grid grid-cols-2 gap-2 mt-3">
              <div className="p-2 rounded bg-red-50 dark:bg-red-950/20">
                <p className="font-medium text-red-700 dark:text-red-300">TVöD E13 (65%)</p>
        ...
        <CardContent className="p-4 md:p-6">
          ...
          <Accordion type="single" collapsible>
            {[
              ...
              { q: 'Can I apply for MEXT and a university position simultaneously?', a: 'Yes! In fact, you should. MEXT provides a stipend while university positions are employment (TVöD). Having both options gives you flexibility.' },
              ...
              { q: 'Is health insurance mandatory?', a: 'Yes, mandatory in Germany. If you have a TVöD position, it is automatically deducted from your salary. MEXT scholars get insurance through MEXT.' },
